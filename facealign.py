...
for filename in os.listdir('faces'):
    ...
    print(filename)  
face = cv2.imread("4.jpg")    
eye_detector = cv2.CascadeClassifier('.venv/lib/python3.12/site-packages/cv2/data/haarcascade_smile.xml') #.venv/lib/python3.12/site-packages/cv2/data/haarcascade_eye_tree_eyeglasses.xml .venv/lib/python3.12/site-packages/cv2/data/haarcascade_eye.xml
face = cv2.cvtColor(face, cv2.COLOR_BGR2GRAY)
cv2.imshow('1', face)

eyes = eye_detector.detectMultiScale(face, 1.2, 4)
print(eyes)
